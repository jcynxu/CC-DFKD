...
from datafree.models.conditional_batchnorm import CategoricalConditionalBatchNorm2d
...
class GeneratorD(nn.Module):
    ...
    def clone(self):
        clone = GeneratorD(self.params[0], self.params[1], self.params[2], self.params[3])
        loaded_state_dict = torch.load('generator_state_dict.pth')
        clone.load_state_dict(loaded_state_dict,strict=True)
        return clone.cuda()
