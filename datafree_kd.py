...
def main():
    ...
    args.logger.info("Generation Cost: %1.3f" % ((end - start) / 3600.))
...
def main_worker(gpu, ngpus_per_node, args):
    ...
    if args.method=='CC-DFKD':
        ...
        synthesizer = datafree.synthesis.Synthesizer(teacher, student, generator, 
                 ...
                 normalizer=args.normalizer, device=args.gpu,dataset=args.dataset,
                 co_alpha = args.co_alpha,
                 co_beta = args.co_beta, co_gamma = args.co_gamma
                 , co_eta = args.co_eta, temp = args.temp, use_amp = args.use_amp,lr_z=args.lr_z)
